...
public class ConfiguracionConexionABaseDeDatos {
    ...
    private Properties leerFicheroDePropiedades() {
        try {
            InputStream is = ProveedorDeConexionesABaseDeDatos.class.getResourceAsStream("/es/ceu/mpII/gestor/alumnos/infraestructura/configuracion_conexion_base_de_datos.properties");
